...
student = (name = "Vidhi Katkoria", kerberos_id = "vidhi.katkoria")
...
ex_1_1 = md"""
Because the assumption, a can be either
1. greater than $\sqrt{x}$
2. smaller than $\sqrt{x}$

So, accordingly, x/a will be smaller or greater than $\sqrt{x}$ for case 1 and 2 respectively. Hence, the answer i.e. $\sqrt{x}$ will always be between a and x/a. 
""" 
